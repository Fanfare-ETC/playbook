...
public class testCollectionFragment extends PlaybookFragment {

    private static final String TAG = testCollectionFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mWebViewIsCompatible) {
            ...
            mWebView.addJavascriptInterface(new testCollectionFragment.JavaScriptInterface(), "PlaybookCollectionBridge");
            mWebView.setWebChromeClient(new testCollectionFragment.PlaybookWebChromeClient());
            ...
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        testCollectionFragment.this.sendMessage(jsonObject);
